...
import 'dpgsql_large_object_manager.dart';
...
/// Porting DpgsqlLargeObjectStream.cs
class DpgsqlLargeObjectStream {
  DpgsqlLargeObjectStream(this._manager, this._fd, this._writeable);

  final DpgsqlLargeObjectManager _manager;
  final int _fd;
