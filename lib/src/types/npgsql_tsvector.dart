...
/// Porting NpgsqlTsVector.cs
class NpgsqlTsVector {
  NpgsqlTsVector(List<Lexeme> lexemes, {bool noCheck = false}) {
    if (noCheck) {
      _lexemes = lexemes;
      return;
    }
  ...
  static final NpgsqlTsVector empty = NpgsqlTsVector([], noCheck: true);
  ...
  bool operator ==(Object other) {
    ...
    if (other is! NpgsqlTsVector) return false;
