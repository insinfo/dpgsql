...
class NpgsqlDbColumn {
  ...
  /// Clone this instance.
  NpgsqlDbColumn clone() {
    return NpgsqlDbColumn()
  ...
  @override
  String toString() {
    return 'NpgsqlDbColumn(columnName: $columnName, dataTypeName: $dataTypeName, '
